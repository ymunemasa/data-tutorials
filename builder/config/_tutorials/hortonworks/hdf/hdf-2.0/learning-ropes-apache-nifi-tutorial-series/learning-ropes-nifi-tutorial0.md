...
![download_hdf_iot]({{page.path}}/assets/lab0-download-install-start-nifi/download-hdf-learn-ropes-nifi.png)
...
![download_install_nifi]({{page.path}}/assets/lab0-download-install-start-nifi/download_install_nifi.png)
...
2\. Login into Ambari as admin. In the left sidebar of services, click on the **Actions** button. A drop down menu appears, select the **Add Service** button ![add_service]({{page.path}}/assets/lab0-download-install-start-nifi/add_service.png). The **Add Service Wizard** window will appear.

![add_service_wizard]({{page.path}}/assets/lab0-download-install-start-nifi/add_service_wizard.png)

Choose the NiFi service:

![select_nifi_service]({{page.path}}/assets/lab0-download-install-start-nifi/select_nifi_service.png)
...
![review_section_nifi]({{page.path}}/assets/lab0-download-install-start-nifi/review_section_nifi.png)
...
![install_started_service_success]({{page.path}}/assets/lab0-download-install-start-nifi/install_started_service_success.png)
...
![summary_section_wizard]({{page.path}}/assets/lab0-download-install-start-nifi/summary_section_wizard.png)
...
![service_installed_succesfully]({{page.path}}/assets/lab0-download-install-start-nifi/service_installed_succesfully.png)
...
![start_nifi_button]({{page.path}}/assets/lab0-download-install-start-nifi/start_nifi_button.png)
...
![open_nifi_html_interface]({{page.path}}/assets/lab0-download-install-start-nifi/open_nifi_html_interface.png)
...
![port_forward_nifi_iot]({{page.path}}/assets/lab0-download-install-start-nifi/port_forward_nifi_iot.png)
...
![shield-icon-security-inbound.png]({{page.path}}/assets/lab0-download-install-start-nifi/shield-icon-security-inbound.png)

3\. Under **Settings**, in the **General** section, click **Inbound Security Rules**.

![inbound-security-rule.png]({{page.path}}/assets/lab0-download-install-start-nifi/inbound-security-rule.png)

4\. Scroll to **NiFi**, and click on the row.

![list-nifi-port.png]({{page.path}}/assets/lab0-download-install-start-nifi/list-nifi-port.png)

5\. Verify the **Destination Port Range** value is 9090, else change it to that.

![change-nifi-port.png]({{page.path}}/assets/lab0-download-install-start-nifi/change-nifi-port.png)
