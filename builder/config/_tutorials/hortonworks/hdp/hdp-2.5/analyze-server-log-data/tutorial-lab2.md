...
![sshTerminal]({{page.path}}/assets/lab2/sshTerminal.png)
...
![mkdir]({{page.path}}/assets/lab2/mkdir.png)
...
![download_logsample]({{page.path}}/assets/lab2/download_logsample.png)
...
![download_geofile]({{page.path}}/assets/lab2/download_geofile.png)
...
![upload_template]({{page.path}}/assets/lab2/upload_template.png)

Once you've uploaded the template into NiFi you can instantiate it by dragging the template icon ![template_icon]({{page.path}}/assets/lab2/template_icon.png) onto the screen. It will ask you to select your template's name and the flow will appear as in the image below.

![nifi_workflow]({{page.path}}/assets/lab2/nifi_workflow.png)
...
![select_files_view]({{page.path}}/assets/lab2/select_files_view.png)
...
![open_file]({{page.path}}/assets/lab2/open_file.png)
...
![file_preview]({{page.path}}/assets/lab2/file_preview.png)
...
![turn_off_maintenance_mode]({{page.path}}/assets/lab2/turn_off_maintenance_mode.png)

Next, click on `Zeppelin Notebook` and then `Quick Links -> Zeppelin UI` to open the Zeppelin UI on the browser:

![quick_links_zeppelin]({{page.path}}/assets/lab2/quick_links_zeppelin.png)
...
![create_new_note]({{page.path}}/assets/lab2/create_new_note.png)
...
![stop_all]({{page.path}}/assets/lab2/stop_all.png)
...
![dep]({{page.path}}/assets/lab2/dep.png)
...
![load_dataframe]({{page.path}}/assets/lab2/load_dataframe.png)
...
![parse_timestamp]({{page.path}}/assets/lab2/parse_timestamp.png)
...
![show_request_type]({{page.path}}/assets/lab2/show_request_type.png)
...
![show_pathdf]({{page.path}}/assets/lab2/show_pathdf.png)
...
![show_most_frequent_hosts]({{page.path}}/assets/lab2/show_most_frequent_hosts.png)
...
![select_most_frequent_hosts]({{page.path}}/assets/lab2/select_most_frequent_hosts.png)
...
![piechart_most_frequent_hosts]({{page.path}}/assets/lab2/piechart_most_frequent_hosts.png)
...
![show_statuscount]({{page.path}}/assets/lab2/show_statuscount.png)
...
![select_status_count]({{page.path}}/assets/lab2/select_status_count.png)

Click the bar chart button:

![barchart_status_count]({{page.path}}/assets/lab2/barchart_status_count.png)
...
![show_success_logs_df]({{page.path}}/assets/lab2/show_success_logs_df.png)
...
![show_success_logs_by_hours_df]({{page.path}}/assets/lab2/show_success_logs_by_hours_df.png)
...
![select_success_logs_by_hour_df]({{page.path}}/assets/lab2/select_success_logs_by_hour_df.png)
...
![show_extension_df]({{page.path}}/assets/lab2/show_extension_df.png)
...
![show_extension_df1]({{page.path}}/assets/lab2/show_extension_df1.png)
...
![show_extension_df2]({{page.path}}/assets/lab2/show_extension_df2.png)
...
![show_extension_df_count]({{page.path}}/assets/lab2/show_extension_df_count.png)
...
![select_extension_df_count]({{page.path}}/assets/lab2/select_extension_df_count.png)
...
![register_path_df]({{page.path}}/assets/lab2/register_path_df.png)
...
![create_table_path_df]({{page.path}}/assets/lab2/create_table_path_df.png)
...
![select_country]({{page.path}}/assets/lab2/select_country.png)
...
![select_city]({{page.path}}/assets/lab2/select_city.png)
