...
![Instantiate NiFi Template]({{page.path}}/assets/step2/instantiate-template.png)
...
![network_traffic_per_country]({{page.path}}/assets/step4/network_traffic_per_country.png)
