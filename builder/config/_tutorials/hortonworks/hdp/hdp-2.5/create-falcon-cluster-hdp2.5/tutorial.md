...
~~~
 ...
 ![create_hdfs_directory]({{page.path}}/assets/create_hdfs_directory.png)
 ...
 ![create_staging_directory]({{page.path}}/assets/create_staging_directory.png)
...
![create_working_directory]({{page.path}}/assets/create_working_directory.png)
...
![quickLinksFalconUI]({{page.path}}/assets/quickLinksFalconUI.png)
-->
