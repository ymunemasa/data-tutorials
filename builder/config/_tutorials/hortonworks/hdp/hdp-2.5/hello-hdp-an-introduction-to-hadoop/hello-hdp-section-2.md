...
![HDFS_3]({{page.path}}/assets/hdfs_files_view_base_folder_concepts.png)
...
Hive users have a choice of 3 runtimes when [executing SQL queries](http://hortonworks.com/blog/5-ways-make-hive-queries-run-faster/). Users can choose between Apache Hadoop MapReduce, Apache Tez or Apache Spark frameworks as their execution backend.
...
![Screen Shot 2016-02-17 at 7.10.18 PM]({{page.path}}/assets/selector_views_concepts.png)


Ambari Hive User View


![Hive_6]({{page.path}}/assets/ambari_hive_user_view_concepts.png)
...
![Screen Shot 2016-02-17 at 7.12.41 PM]({{page.path}}/assets/ambari_pig_view_concepts.png)
...
![Pig_2]({{page.path}}/assets/pig_view_scripts_list_empty_concepts.png)
...
![Pig_3]({{page.path}}/assets/pig_view_workspace_interface_concepts.png)
