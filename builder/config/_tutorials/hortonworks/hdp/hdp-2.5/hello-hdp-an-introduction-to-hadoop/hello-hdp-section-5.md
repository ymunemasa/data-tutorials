...
![riskfactor_table]({{page.path}}/assets/riskfactor_lab3.png)
...
![Screen Shot 2015-07-21 at 10.12.41 AM]({{page.path}}/assets/ambari_pig_view_lab3.png)
...
![Lab3_5]({{page.path}}/assets/pig_user_view_components_hello_hdp.png)
...
![Lab3_6]({{page.path}}/assets/new_script_hello_hdp_lab3.png)
...
![Lab3_8]({{page.path}}/assets/riskfactor_computation_script_lab3.png)
...
![Lab3_11]({{page.path}}/assets/execute_pig_script_compute_riskfactor_hello_hdp_lab3.png)
...
![Lab3_12]({{page.path}}/assets/running_script_riskfactor_hello_hdp_lab3.png)

![Lab3_13]({{page.path}}/assets/completed_riskfactor_script_hello_hdp_lab3.png)
...
![debug_through_logs_lab3]({{page.path}}/assets/debug_through_logs_lab3.png)
...
![Lab3_14]({{page.path}}/assets/pig_populated_riskfactor_table_hello_hdp_lab3.png)
