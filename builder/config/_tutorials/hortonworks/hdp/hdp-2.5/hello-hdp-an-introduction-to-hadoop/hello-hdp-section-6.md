...
![ambari_dashboard_lab4]({{page.path}}/assets/ambari_dashboard_lab4.png)
...
![verify_spark_livy_server_lab4]({{page.path}}/assets/verify_spark_livy_server_lab4.png)
...
![start_livy_server_lab4]({{page.path}}/assets/start_livy_server_lab4.png)

Livy Server Started:

![livy_server_running_lab4]({{page.path}}/assets/livy_server_running_lab4.png)
...
![zeppelin_view_lab4]({{page.path}}/assets/zeppelin_view_lab4.png)

2\. Below is an image of the welcome screen from Zeppelin View, as you can see users must login to create notebooks:

![zeppelin_view_welcome_lab4]({{page.path}}/assets/zeppelin_view_welcome_lab4.png)
...
![zeppelin_welcome_page]({{page.path}}/assets/zeppelin_welcome_page_lab4.png)
--->
...
![create_new_notebook]({{page.path}}/assets/create_new_notebook_hello_hdp_lab4.png)

![notebook_name]({{page.path}}/assets/notebook_name_hello_hdp_lab4.png)
...
![drop_table_lab4]({{page.path}}/assets/drop_table_lab4.png)
...
![import_sql_libraries]({{page.path}}/assets/import_sql_libraries_hello_hdp_lab4.png)
...
![Lab4_6]({{page.path}}/assets/instantiate_hivecontext_hello_hdp_lab4.png)
...
![Lab4_7]({{page.path}}/assets/view_list_tables_hive_hello_hdp_lab4.png)
...
![Lab4_8]({{page.path}}/assets/query_tables_build_spark_rdd_hello_hdp_lab4.png)
...
![Lab4_9]({{page.path}}/assets/drivermileage_spark_rdd_hello_hdp_lab4.png)
...
![name_rdd]({{page.path}}/assets/name_rdd_hello_hdp_lab4.png)
...
![filter_drivers_nonnormal_events]({{page.path}}/assets/filter_drivers_nonnormal_events_hello_hdp_lab4.png)
...
![register_table]({{page.path}}/assets/register_filtered_table_hello_hdp_lab4.png)
...
![Lab4_11]({{page.path}}/assets/view_results_op_on_rdd_hello_hdp_lab4.png)
...
![Lab4_12]({{page.path}}/assets/join_op_column_hello_hdp_lab4.png)
...
![register_join_table]({{page.path}}/assets/register_joined_table_hello_hdp_lab4.png)
...
![Lab4_13]({{page.path}}/assets/show_results_joined_table_hello_hdp_lab4.png)
...
![Lab4_14]({{page.path}}/assets/calculate_riskfactor_hello_hdp_lab4.png)
...
![Lab4_15]({{page.path}}/assets/view_results_filtertable_hello_hdp_lab4.png)
...
![create_orc_table]({{page.path}}/assets/create_orc_table_hello_hdp_lab4.png)
...
![risk_factor_orc]({{page.path}}/assets/convert_orc_table_hello_hdp_lab4.png)
...
![load_data_to_finalresults]({{page.path}}/assets/load_data_to_finalresults_hello_hdp_lab4.png)
...
![create_table_riskfactor_spark]({{page.path}}/assets/create_table_riskfactor_spark.png)
...
![riskfactor_table_populated]({{page.path}}/assets/riskfactor_table_populated.png)
...
![spark_shell_welcome_page]({{page.path}}/assets/spark_shell_hello_hdp_lab4.png)
