...
![HDSF_1]({{page.path}}/assets/HDSF_1.png)
...
![HDFS_3]({{page.path}}/assets/HDFS_3.png)
...
![MapR_1]({{page.path}}/assets/MapR_1.png)
...
![MapR_2]({{page.path}}/assets/MapR_2.png)
...
![MapR_3]({{page.path}}/assets/MapR_3.png)
...
![Hive_1]({{page.path}}/assets/Hive_1.png)

![Hive_2]({{page.path}}/assets/Hive_2.png)

![Hive_3]({{page.path}}/assets/Hive_3.png)
...
![Hive_4]({{page.path}}/assets/Hive_4.png)
...
![Screen Shot 2015-07-21 at 10.10.18 AM]({{page.path}}/assets/Screen-Shot-2015-07-21-at-10.10.18-AM.png)

Ambari Hive User View

![Hive_6]({{page.path}}/assets/Hive_6.png)
...
![Screen Shot 2015-07-21 at 10.12.41 AM]({{page.path}}/assets/Screen-Shot-2015-07-21-at-10.12.41-AM.png)
...
![Pig_2]({{page.path}}/assets/Pig_2.png)
...
![Pig_3]({{page.path}}/assets/Pig_3.png)
...
![Lab0_1]({{page.path}}/assets/Lab0_1.png)
...
![Lab0_2]({{page.path}}/assets/Lab0_2.png)
...
![Screen Shot 2015-07-20 at 6.11.32 PM]({{page.path}}/assets/Screen-Shot-2015-07-20-at-6.11.32-PM.png)
...
![Lab0_3]({{page.path}}/assets/Lab0_3.png)
...
![Screen Shot 2015-07-21 at 10.17.21 AM]({{page.path}}/assets/Screen-Shot-2015-07-21-at-10.17.21-AM.png)
...
![Lab2_2]({{page.path}}/assets/Lab2_2.png)

*   Click tmp. Then click  ![Lab2_3]({{page.path}}/assets/Lab2_3.png) button to create the `/tmp/admin` directory and then create the `/tmp/admin/data` directory.

![Screen Shot 2015-07-27 at 9.42.07 PM]({{page.path}}/assets/Screen-Shot-2015-07-27-at-9.42.07-PM.png)

*   Now traverse to the /tmp/admin/data directory and upload the corresponding geolocation.csv and trucks.csv files into it.

![Screen Shot 2015-07-27 at 9.43.28 PM]({{page.path}}/assets/Screen-Shot-2015-07-27-at-9.43.28-PM.png)
...
![Lab2_5]({{page.path}}/assets/Lab2_5.png)
...
![Screen Shot 2015-07-21 at 10.10.18 AM]({{page.path}}/assets/Screen-Shot-2015-07-21-at-10.10.18-AM-300x208.png)

The Ambari Hive User View looks like the following:

![Lab2_2]({{page.path}}/assets/Lab2_21.png)
...
![Lab2_3]({{page.path}}/assets/Lab2_31.png)
...
![Lab2_4]({{page.path}}/assets/Lab2_41.png)

3.  Create a new Worksheet by clicking the blue **New Worksheet** button:

![Lab2_5]({{page.path}}/assets/Lab2_51.png)
...
![Lab2_6]({{page.path}}/assets/Lab2_6.png)
...
![Lab2_7]({{page.path}}/assets/Lab2_7.png)
...
![Lab2_8]({{page.path}}/assets/Lab2_8.png)
...
![Screen Shot 2015-07-27 at 9.45.11 PM]({{page.path}}/assets/Screen-Shot-2015-07-27-at-9.45.11-PM.png)

2.  After clicking on the **Move** arrow your screen should look like the following:

![Lab2_10]({{page.path}}/assets/Lab2_10.png)
...
![Lab2_11]({{page.path}}/assets/Lab2_111.png)
...
![Lab2_12]({{page.path}}/assets/Lab2_12.png)
...
![Lab2_13]({{page.path}}/assets/Lab2_13.png)
...
![Lab2_14]({{page.path}}/assets/Lab2_14.png)
...
![Lab2_15]({{page.path}}/assets/Lab2_15.png)
...
![Lab2_16]({{page.path}}/assets/Lab2_16.png)
...
![Lab2_19]({{page.path}}/assets/Lab2_19.png)
...
![Lab2_20]({{page.path}}/assets/Lab2_20.png)
...
![Lab2_22]({{page.path}}/assets/Lab2_22.png)
...
![Lab2_23]({{page.path}}/assets/Lab2_23.png)
...
![Screen Shot 2015-07-21 at 10.22.56 AM]({{page.path}}/assets/Screen-Shot-2015-07-21-at-10.22.56-AM.png)
Select the first DAG as it represents the last job that was executed.

![Lab2_34]({{page.path}}/assets/Lab2_34.png)
...
![Lab2_35]({{page.path}}/assets/Lab2_35.png)
...
![Lab2_36]({{page.path}}/assets/Lab2_36.png)
...
![Lab3_1]({{page.path}}/assets/Lab3_1.png)
...
![Lab3_2]({{page.path}}/assets/Lab3_2.png)
...
![Lab3_8]({{page.path}}/assets/Lab3_8.png)
...
![Lab3_11]({{page.path}}/assets/Lab3_11.png)
...
![Lab3_12]({{page.path}}/assets/Lab3_12.png)

![Lab3_13]({{page.path}}/assets/Lab3_13.png)
...
![Lab3_14]({{page.path}}/assets/Lab3_14.png)
...
![Lab4_1]({{page.path}}/assets/Lab4_1.png)
Lets get started…!!
...
![Lab4_2]({{page.path}}/assets/Lab4_2.png)

![Lab4_3]({{page.path}}/assets/Lab4_3.png)
...
![Lab4_4]({{page.path}}/assets/Lab4_4.png)
...
![Lab4_5]({{page.path}}/assets/Lab4_5.png)
...
![Lab4_6]({{page.path}}/assets/Lab4_6.png)
...
![Lab4_7]({{page.path}}/assets/Lab4_7.png)
...
![Lab4_8]({{page.path}}/assets/Lab4_8.png)

~~~
val drivermileage_temp1 = hiveContext.sql("select * from drivermileage")
~~~

![Lab4_9]({{page.path}}/assets/Lab4_9.png)
...
![Lab4_11]({{page.path}}/assets/Lab4_11.png)
...
![Lab4_12]({{page.path}}/assets/Lab4_12.png)
...
![Lab4_13]({{page.path}}/assets/Lab4_13.png)
...
![Lab4_14]({{page.path}}/assets/Lab4_14.png)
...
![Lab4_15]({{page.path}}/assets/Lab4_15.png)
...
![Lab5_6]({{page.path}}/assets/Lab5_6.png)
