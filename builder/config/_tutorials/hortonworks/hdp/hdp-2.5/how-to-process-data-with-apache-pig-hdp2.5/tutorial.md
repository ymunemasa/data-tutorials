...
![create_new_script]({{page.path}}/assets/create_new_script.png)
...
![new_script_page]({{page.path}}/assets/new_script_page.png)
...
![load_driver_data]({{page.path}}/assets/load_driver_data.png)
...
![filter_driver_data]({{page.path}}/assets/filter_driver_data.png)
...
![foreach_name_fields]({{page.path}}/assets/foreach_name_fields.png)
...
![iterate_pulls_fields_driver]({{page.path}}/assets/iterate_pulls_fields_driver.png)
...
![iterate_pulls_fields_timesheet]({{page.path}}/assets/iterate_pulls_fields_timesheet.png)
...
![group_timesheet_by_driverId]({{page.path}}/assets/group_timesheet_by_driverId.png)
...
![sum_hours_miles_logged]({{page.path}}/assets/sum_hours_miles_logged.png)
...
![join_data_objects]({{page.path}}/assets/join_data_objects.png)
...
![script_running]({{page.path}}/assets/script_running.png)
...
![script_results]({{page.path}}/assets/script_results.png)
...
![script_logs]({{page.path}}/assets/script_logs.png)
...
![execute_script_on_tez]({{page.path}}/assets/execute_script_on_tez.png)

Notice the time after the execution completes:

![script_logs_with_tez]({{page.path}}/assets/script_logs_with_tez.png)
