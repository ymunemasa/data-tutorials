...
![hive_config_page]({{page.path}}/assets/hive_config_page.png)

Scroll down to find **Custom hive-site** section, click on `Add Property` button, following pop up will come:

![add_property]({{page.path}}/assets/add_property.png)
...
![added_property]({{page.path}}/assets/added_property.png)
...
![create_external_table]({{page.path}}/assets/create_external_table.png)
...
![view_table]({{page.path}}/assets/view_table.png)
