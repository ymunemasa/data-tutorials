...
![start_hbase_service_iot]({{page.path}}/assets/lab2-hbase-hive-storm/start_hbase_service_iot.png)
...
![list_files_target_folder]({{page.path}}/assets/tutorial0-setup-environ/list_files_target_folder.png)
