...
![splittext_property_config_nifi_iot]({{page.path}}/assets/lab0-nifi/splittext_property_config_nifi_iot.png)
...
![run_dataflow_nifi_iot]({{page.path}}/assets/lab0-nifi/run_dataflow_nifi_iot.png)
