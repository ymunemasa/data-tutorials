...
![user_env_sh_setup_auto_script_iot]({{page.path}}/assets/lab2-hbase-hive-storm/user_env_sh_setup_auto_script_iot.png)
...
![kafka_broker_hostname_verify]({{page.path}}/assets/lab2-hbase-hive-storm/kafka_broker_hostname_verify.png)
...
![config_properties_file_verify_hosts_match]({{page.path}}/assets/lab2-hbase-hive-storm/config_properties_file_verify_hosts_match.png)
...
![Screen Shot 2015-06-04 at 7.55.23 PM.png]({{page.path}}/assets/lab2-hbase-hive-storm/storm_topology_submitted_success_storm_iot.png)
...
![trucking_demo_sign_in]({{page.path}}/assets/lab2-hbase-hive-storm/trucking_demo_sign_in.png)

The HDP Storm Demo Dashboard will appear:

![hdp_storm_demo_dashboard_iot]({{page.path}}/assets/lab2-hbase-hive-storm/hdp_storm_demo_dashboard_iot.png)
...
![storm_topology_tuples_increasing]({{page.path}}/assets/lab2-hbase-hive-storm/storm_topology_tuples_increasing.png)
...
![driver_monitoring_app_map]({{page.path}}/assets/lab2-hbase-hive-storm/driver_monitoring_app_map.png)
![driver_monitoring_app_table]({{page.path}}/assets/lab2-hbase-hive-storm/driver_monitoring_app_table.png)


Real-Time Driver Behavior Predictions Application

![driver_behavior_predictions_app_map]({{page.path}}/assets/lab2-hbase-hive-storm/driver_behavior_predictions_app_map.png)
![driver_behavior_predictions_app_table]({{page.path}}/assets/lab2-hbase-hive-storm/driver_behavior_predictions_app_table.png)


Real-Time Drools Driven Monitoring Application

![drools_driven_driver_alerts_app_map]({{page.path}}/assets/lab2-hbase-hive-storm/drools_driven_driver_alerts_app_map.png)
![drools_driven_driver_alerts_app_table]({{page.path}}/assets/lab2-hbase-hive-storm/drools_driven_driver_alerts_app_table.png)
