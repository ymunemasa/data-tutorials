...
![ambari_dashboard_rajops_infra]({{page.path}}/assets/ambari_dashboard_rajops_infra.png)
...
![click_sandbox_knox]({{page.path}}/assets/click_sandbox_knox.png)

You can review all policies details by a clicking on the policy name.

![list_policies_knox]({{page.path}}/assets/list_policies_knox.png)
...
![knox_global_policy_disabled]({{page.path}}/assets/knox_global_policy_disabled.png)
...
![guest_policy_enabled]({{page.path}}/assets/guest_policy_enabled.png)
...
![admin_forbidden_knox]({{page.path}}/assets/admin_forbidden_knox.png)
...
![audit_results_knox_denied]({{page.path}}/assets/audit_results_knox_denied.png)
...
![guest_allowed_knox]({{page.path}}/assets/guest_allowed_knox.png)
...
![audit_results_knox_allowed]({{page.path}}/assets/audit_results_knox_allowed.png)
...
![list_policies]({{page.path}}/assets/list_policies.png)
...
![access_error_rajops]({{page.path}}/assets/access_error_rajops.png)
...
![audit_result_rajops]({{page.path}}/assets/audit_result_rajops.png)
...
![click_on_all_database]({{page.path}}/assets/click_on_all_database.png)

Scroll down and add raj_ops to the list of users in the Allow Conditions. Do not change anything else.

![add_rajops_in_allowconditions]({{page.path}}/assets/add_rajops_in_allowconditions.png)
...
![hive_succeeded]({{page.path}}/assets/hive_succeeded.png)
...
![hive_policy_created]({{page.path}}/assets/hive_policy_created.png)
...
![hbase_global_allow_disabled]({{page.path}}/assets/hbase_global_allow_disabled.png)
...
![hbase_permission_denied]({{page.path}}/assets/hbase_permission_denied.png)
...
![hbase_click_on_all_table]({{page.path}}/assets/hbase_click_on_all_table.png)

Scroll down below and add **raj_ops** to the list of users in Allow Conditions.

![hbase_allow_conditions]({{page.path}}/assets/hbase_allow_conditions.png)
...
![hbase_succeeded]({{page.path}}/assets/hbase_succeeded.png)
...
![hbase_policy_created]({{page.path}}/assets/hbase_policy_created.png)
...
![hbase_revoke_holgergov]({{page.path}}/assets/hbase_revoke_holgergov.png)
...
![hdfs_succeeded]({{page.path}}/assets/hdfs_succeeded.png)
...
![hdfs_policy_created]({{page.path}}/assets/hdfs_policy_created.png)

Click on the policy and check the permissions that has been created

![hdfs_view_policy]({{page.path}}/assets/hdfs_view_policy.png)
...
![hdfs_read_policy]({{page.path}}/assets/hdfs_read_policy.png)
