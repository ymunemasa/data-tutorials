...
![new_ambari_dashboard]({{page.path}}/assets/new_ambari_dashboard.png)
...
![click_sandbox_hive_rajops]({{page.path}}/assets/click_sandbox_hive_rajops.png)
...
![click_policy_for_all_users_rajops]({{page.path}}/assets/click_policy_for_all_users_rajops.png)

This policy is meant for these 4 users and is applied to all tables and all columns of a `foodmart` database.

![sample_foodmart_policy_rajops]({{page.path}}/assets/sample_foodmart_policy_rajops.png)

To check the type of access that this policy imposed on these users, scroll down:

![allow_condition_sample_policy_rajops]({{page.path}}/assets/allow_condition_sample_policy_rajops.png)
...
![create_hive_table]({{page.path}}/assets/create_hive_table.png)
...
![list_hive_table]({{page.path}}/assets/list_hive_table.png)
...
![view_data]({{page.path}}/assets/view_data.png)
...
![ranger_homepage_rajops]({{page.path}}/assets/ranger_homepage_rajops.png)

Go back to `Sandbox_hive` and then `Add New Policy`:

![new_sandbox_hive_policies]({{page.path}}/assets/new_sandbox_hive_policies.png)
...
![add_permission]({{page.path}}/assets/add_permission.png)

You should have your policy configured like this:

![employee_policy_rajops]({{page.path}}/assets/employee_policy_rajops.png)

Click on `Add` and you can see the list of policies that are present in `Sandbox_hive`.

![employee_policy_added_rajops]({{page.path}}/assets/employee_policy_added_rajops.png)
...
![hive_global_policy_rajops]({{page.path}}/assets/hive_global_policy_rajops.png)

To check the access, get back to Ambari as `maria_dev` user.

![maria_dev_ambari_login]({{page.path}}/assets/maria_dev_ambari_login.png)

Go directly to `Hive View`, click on default database and employee table. Press the button to view the table data.

![maria_dev_access_error]({{page.path}}/assets/maria_dev_access_error.png)
...
![new_policy_audit]({{page.path}}/assets/new_policy_audit.png)
...
![maria_dev_access_successful]({{page.path}}/assets/maria_dev_access_successful.png)
...
![restrict_policy_rajops]({{page.path}}/assets/restrict_policy_rajops.png)
...
![pii_tag_assigned_rajops]({{page.path}}/assets/pii_tag_assigned_rajops.png)
...
![select_tag_based_policies_rajops]({{page.path}}/assets/select_tag_based_policies_rajops.png)

You will see a page like given below.

![new_tag_rajops]({{page.path}}/assets/new_tag_rajops.png)

Click `+` button to create a new tag service.

![add_sandbox_tag_rajops]({{page.path}}/assets/add_sandbox_tag_rajops.png)

Give it a name `Sandbox_tag` and click `Add`.

![added_sandbox_tag_rajops]({{page.path}}/assets/added_sandbox_tag_rajops.png)

Click on `Sandbox_tag` to add a policy.

![add_new_policy_rajops]({{page.path}}/assets/add_new_policy_rajops.png)
...
![pii_column_access_policy_rajops]({{page.path}}/assets/pii_column_access_policy_rajops.png)
...
![admin_access_successful]({{page.path}}/assets/admin_access_successful.png)
...
![audit_results_rajops]({{page.path}}/assets/audit_results_rajops.png)
