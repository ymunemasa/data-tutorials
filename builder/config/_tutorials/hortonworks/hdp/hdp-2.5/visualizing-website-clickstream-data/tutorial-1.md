...
Let's open the `Hive View` by clicking on the Hive button from the `views menu` ![views_menu]({{page.path}}/assets/lab1/views_menu.png).
...
![load_dataset_hive_tables]({{page.path}}/assets/lab1/load_dataset_hive_tables.png)
