...
![ambari_login](/assets/configuring-yarn-capacity-scheduler/ambari_login.png)

After you Login, you will see the Dashboard. This is an unified view of the state of your Sandbox.

![ambari_dashboard_rajops](/assets/configuring-yarn-capacity-scheduler/ambari_dashboard_rajops.png)
...
![select_yarn](/assets/configuring-yarn-capacity-scheduler/select_yarn.png)

We will start updating the configuration for Yarn Capacity Scheduling policies. Click on `Configs` tab.

![select_configs_tab](/assets/configuring-yarn-capacity-scheduler/select_configs_tab.png)
...
![capacity_scheduler_section](/assets/configuring-yarn-capacity-scheduler/capacity_scheduler_section.png)
...
![select_resourcemanagerui](/assets/configuring-yarn-capacity-scheduler/select_resourcemanagerui.png)

Click on `Scheduler` and you can see below we just have the **default** policy.

![resource_manager_ui](/assets/configuring-yarn-capacity-scheduler/resource_manager_ui.png)
...
![copy_paste_policy](/assets/configuring-yarn-capacity-scheduler/copy_paste_policy.png)

Click `Save` and confirm on the dialog box:

![popup](/assets/configuring-yarn-capacity-scheduler/popup.png)
...
![restart_needed](/assets/configuring-yarn-capacity-scheduler/restart_needed.png)
...
![new_version](/assets/configuring-yarn-capacity-scheduler/new_version.png)

Wait for the restart to complete:

![restart_yarn_progress](/assets/configuring-yarn-capacity-scheduler/restart_yarn_progress.png)

and then go back to the Resource Manager UI  and refresh the page. Voila! There’s our new policy:

![resource_manager_ui_new_policy](/assets/configuring-yarn-capacity-scheduler/resource_manager_ui_new_policy.png)
