...
In this tutorial, we will introduce core concepts of Apache Spark Streaming and run a quick Word Count demo that computes an incoming list of words every two seconds.
...
Now that you've completed this tutorial, checkout other Spark tutorials  [here](http://hortonworks.com/hadoop/spark/#tutorials).
